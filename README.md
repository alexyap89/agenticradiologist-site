...
| **[pRIMe-MRI](https://primemri.netlify.app)** | Patient preparation for MRI — a 5-minute 360° preparatory video and interactive 3D scanner room with guided breath-hold practice and real 1.5 T scanner audio. A prospective, single-centre improvement and value pilot (target >200 patients) collecting patient-reported experience measures as the primary endpoint — one of my department's first PREM/PROM-based projects. Vibe-coded, phone-first, no headset required |
